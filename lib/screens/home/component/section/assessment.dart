...
class _AssessmentState extends State<Assessment> {
    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        body: Consumer<SuggestProvider>(
          builder: (context, sprovider, child) => GestureDetector(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          buildQuestion(sprovider.assessments[0]!.assessName),
                          buildScore(context, 0),
                          SizedBox(height: 3.h),
                          buildQuestion(sprovider.assessments[1]!.assessName),
                          buildScore(context, 1),
                          SizedBox(height: 3.h),
                          buildQuestion(sprovider.assessments[2]!.assessName),
                          buildScore(context, 2),
                          SizedBox(height: 3.h),
                          buildQuestion(sprovider.assessments[3]!.assessName),
                          buildScore(context, 3),
                          SizedBox(height: 3.h),
                          buildQuestion(sprovider.assessments[4]!.assessName),
  ...
  Future processAssessment() async {
    ...
    if (status) {
      Navigator.pushNamed(context, RoutePage.routeSuccess);
    } else {
