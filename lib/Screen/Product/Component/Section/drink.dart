...
class Drink extends StatefulWidget {
  final List<ProductModel> productDrinks;
  const Drink({Key? key, required this.productDrinks}) : super(key: key);
...
class _DrinkState extends State<Drink> {
  ...
  void initState() {
    ...
    productModels = widget.productDrinks;
  }
  ...
  Future refreshList() async {
    productModels = await ProductApi().getProductWhereType('เครื่องดื่ม');
    setState(() {});
  }
