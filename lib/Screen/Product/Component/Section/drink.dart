    ...
    return SafeArea(
      ...
      child: Scaffold(
        ...
        body: Consumer<ProductProvider>(
          builder: (_, value, __) => value.productsDrink.isNotEmpty
              ? GridView.builder(
                  shrinkWrap: true,
                  ...
                  itemCount: value.productsDrinkLength,
                  gridDelegate: const SliverGridDelegateWithMaxCrossAxisExtent(
                      childAspectRatio: 2 / 3, maxCrossAxisExtent: 160),
                  itemBuilder: (context, index) {
                    return buildProductItem(value.productsDrink[index], index);
                  },
                )
              : Center(
                  child: Column(
                    ...
                    children: [
                      Text(
                        'ไม่มีรายการ "เครื่องดื่ม" ในขณะนี้',
