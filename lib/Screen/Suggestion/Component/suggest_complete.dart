...
class SuggestComplete extends StatefulWidget {
  const SuggestComplete({Key? key}) : super(key: key);

  @override
  _SuggestCompleteState createState() => _SuggestCompleteState();
}

class _SuggestCompleteState extends State<SuggestComplete> {
  @override
  ...
  Widget buildFuture() {
    return Row(
      ...
      children: [
        Text(
          'เตรียมพบกับระบบสั่งอาหารใน Application ได้ในเร็วๆนี้',
