...
class _EditProductState extends State<EditProduct> {
  ...
  void initState() {
    super.initState();
    chooseType = widget.product.productType;
    nameController.text = widget.product.productName;
    priceController.text = widget.product.productPrice.toString();
    scoreController.text = widget.product.productScore.toString();
    detailController.text = widget.product.productDetail;
    image = widget.product.productImage;
    if (widget.product.productSuggest == 1) {
      suggest = true;
    } else {
      suggest = false;
    }
        ...
        body: GestureDetector(
          ...
          child: Stack(
            children: [
              ...
              ScreenWidget().appBarTitle('แก้ไขรายการอาหาร'),
  ...
  Future processUpdate() async {
    int id = widget.product.productId;
    ...
    if (status) {
      ShowToast().toast('แก้ไขรายการอาหารเรียบร้อยแล้ว');
