...
class EditShopAdmin extends StatefulWidget {
  ...
  const EditShopAdmin({Key? key, required this.shop, required this.time})
      : super(key: key);
...
class _EditShopAdminState extends State<EditShopAdmin> {
  ...
  void getData() {
    ...
    addressController.text = widget.shop.shopAddress;
    latController.text = widget.shop.shopLat.toString();
    lngController.text = widget.shop.shopLng.toString();
