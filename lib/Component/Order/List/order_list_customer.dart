import 'package:charoz/Component/Order/Modal/order_detail_customer.dart';
...
class OrderListCustomer extends StatelessWidget {
  const OrderListCustomer({Key? key}) : super(key: key);
            ...
            : ListView.builder(
                ...
                itemBuilder: (context, index) {
                  Provider.of<ShopProvider>(context, listen: false)
                      .selectShopWhereId(oprovider.orderList[index].shopId);
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () {
          ...
          OrderDetailCustomer().openModalOrderDetail(context);
        },
        child: Padding(
          padding: EdgeInsets.all(15.sp),
          child: Consumer2<ShopProvider, UserProvider>(
            builder: (_, sprovider, uprovider, __) => Column(
              children: [
                Row(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        SizedBox(width: 2.w),
                        Text('ร้านอาหาร : ', style: MyStyle().boldBlue16()),
                      ],
                    ),
                      ...
                      Row(
                        children: [
                          Icon(Icons.location_pin,
                              size: 20.sp, color: MyStyle.bluePrimary),
                          SizedBox(width: 2.w),
                          Text('สถานที่รับ : ', style: MyStyle().boldBlue16()),
                        ],
                      ),
                      ...
                      Row(
                        children: [
                          Icon(Icons.delivery_dining_rounded,
                              size: 20.sp, color: MyStyle.bluePrimary),
                          SizedBox(width: 2.w),
                          Text('ชื่อคนขับ : ', style: MyStyle().boldBlue16()),
                        ],
                      ),
                      order.riderId == 0
  ...
  Color checkOrderStatusColor(String type, String status) {
    if (status == GlobalVariable.orderReceiveTypeList[0]) {
    ...
    } else if (status == GlobalVariable.orderReceiveTypeList[1]) {
