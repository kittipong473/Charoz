    ...
    showModal(
      ...
      builder: (dialogContext) => SimpleDialog(
        title: Column(
          ...
          children: [
            Text(noti.name, style: MyStyle().boldPrimary20()),
            SizedBox(height: 3.h),
            SizedBox(
              width: 50.w,
              height: 50.w,
            ...
            SizedBox(
              width: 60.w,
              child: Text(noti.detail, style: MyStyle().normalBlack16()),
            ),
            SizedBox(height: 3.h),
            Text(
              'เริ่มต้น : ${MyFunction().convertToDateTime(noti.start)}',
              style: MyStyle().boldBlue16(),
            ),
            SizedBox(height: 1.h),
            Text(
              'สิ้นสุด : ${MyFunction().convertToDateTime(noti.end)}',
              style: MyStyle().boldBlue16(),
            ),
            SizedBox(height: 1.h),
          ],
