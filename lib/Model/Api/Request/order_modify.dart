...
class OrderManage {
  ...
  factory OrderManage.fromMap(Map<String, dynamic> map) {
    return OrderManage(
      shopid: map['shopid'] ?? '',
      riderid: map['riderid'] ?? '',
  ...
  factory OrderManage.fromJson(String source) => OrderManage.fromMap(json.decode(source));
